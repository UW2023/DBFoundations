...
-- 2017-01-01,BHoene,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_BHoene')
	 Begin 
	  Alter Database [Assignment06DB_BHoene] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_BHoene;
	 End
	Create Database Assignment06DB_BHoene;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_BHoene;
...
CREATE VIEW vEmployeesByManager
	AS
		SELECT TOP 10000000000
			m.EmployeeFirstName + ' ' + m.EmployeeLastName AS 'ManagerName', e.EmployeeFirstName + ' ' + e.EmployeeLastName AS 'EmployeeName'
